...
public interface MetadataService extends RootService {
	 ...
	 *             if anything goes wrong
	 */
	public Map<String, String> getMapRelations(String terminology,
			String version) throws Exception;
	 ...
	 * relationship types define "parent" and "child" relationships. When
	 * looking through a concept's relationships, anything with one of these
	 * types means the destinationId is a "parent". When looking through a
	 * concept's inverse relationships, anything with one of these types means
	 * the sourceId is a "child".
	 * 
	 * @param terminology
	 *            the terminology
	 * @param version
