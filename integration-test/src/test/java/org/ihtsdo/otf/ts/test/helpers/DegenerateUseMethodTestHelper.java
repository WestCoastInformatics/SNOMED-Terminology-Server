...
public class DegenerateUseMethodTestHelper {
  ...
  public enum ExpectedFailure {
    ...
    /**
     * Use when invalid long value produces empty list object instead of
     * throwing exception; null still throws exception.
     */
      ...
      try {
        ...
        switch (expectedFailure) {
          ...
          case LONG_INVALID_NULL_RESULT_NULL_EXCEPTION:
            ...
            if (result != null) {
              throw new Exception(
                  "Test expecting null result returned non-null result");
            }
            break;
