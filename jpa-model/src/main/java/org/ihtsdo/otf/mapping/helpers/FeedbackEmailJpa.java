...
public class FeedbackEmailJpa implements FeedbackEmail {
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.helpers.FeedbackEmail#setSender(org.ihtsdo.otf.mapping
   * .model.String)
   */
  @Override
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.helpers.FeedbackEmail#setRecipients(org.ihtsdo.otf
   * .mapping.helpers.List<String>)
   */
  @Override
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.helpers.FeedbackEmail#setSubject(java.lang.String)
   */
  @Override
   ...
   * 
   * @see
   * org.ihtsdo.otf.mapping.helpers.FeedbackEmail#setEmailText(java.lang.String)
   */
  @Override
