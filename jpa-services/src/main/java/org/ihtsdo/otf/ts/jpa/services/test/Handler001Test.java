...
public class Handler001Test {
  ...
  @Test
	public void testHandlerNormalUse001() throws Exception {
	    ...
	    for (Description description : icdConcept.getDescriptions()) {
	    	if (description.getTypeId().equals("4"))
	    		assertEquals(handlerService.isPreferredName(description, new LanguageRefSetMemberJpa()), true);
	    	else
	    		assertEquals(handlerService.isPreferredName(description, new LanguageRefSetMemberJpa()), false);
	    }
  }
  ...
  public void testHandlerEdgeCases001() throws Exception {
	  ...
	  //TEST: returns false
	  assertEquals(handlerService.isPreferredName(new DescriptionJpa(), new LanguageRefSetMemberJpa()), false);
  }
