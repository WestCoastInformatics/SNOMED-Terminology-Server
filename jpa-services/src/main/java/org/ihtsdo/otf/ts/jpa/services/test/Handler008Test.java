  ...
  @Test
	public void testHandlerNormalUse008() throws Exception {
		...
		Call getTerminologyId() on the concept
			TEST: The concept's terminology id should match the terminology id returned by the service
		Clear the terminology id 
	    Call getTerminologyId() on the relationship
	    	TEST: the terminology id should be reassigned with the next incremented value
	    */
	    ...
	    Call getTerminologyId() on the description	    
	        TEST: the description's terminology id should match the terminology id returned by the service
	    Clear the terminology id 
	    Call getTerminologyId() on the relationship
	    	TEST: the terminology id should be reassigned with the next incremented value
	    */
	    ...
	    Call getTerminologyId() on the relationship
	        TEST: the relationship's terminology id should match the terminology id returned by the service
	    Clear the terminology id 
	    Call getTerminologyId() on the relationship
	    	TEST: the terminology id should be reassigned with the next incremented value
	    */  	
	    ...
	    try {
	    	UUID.fromString(sctArdrm.getTerminologyId());
	    } catch (Exception e) {
