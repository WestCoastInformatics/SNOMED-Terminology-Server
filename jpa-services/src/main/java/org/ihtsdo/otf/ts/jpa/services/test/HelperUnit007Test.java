...
public class HelperUnit007Test {
  ...
  @Test
	public void testHelperNormalUse007() throws Exception {
		...
		Logger.getLogger(getClass()).info(ConceptReportHelper.getConceptReport(concept));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Concept = 1"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("Description"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("Relationship"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AttributeValue"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AssociationReference"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("SimpleMap"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("Simple"));
		...
		Logger.getLogger(getClass()).info(ConceptReportHelper.getConceptReport(concept));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Concept = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Description = 1"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("Relationship"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AttributeValue"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AssociationReference"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap"));
		...
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Concept = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Description = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Relationship = 1"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AttributeValue"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AssociationReference"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("SimpleMap"));
		...
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Description = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Relationship = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("AttributeValue = 1"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("AssociationReference"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("SimpleMap"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("Simple"));
		...
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains(
				"AssociationReference = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap = 1"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("SimpleMap"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("Simple"));
		...
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains(
				"AssociationReference = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Simple = 1"));
		assertFalse(ConceptReportHelper.getConceptReport(concept).contains("SimpleMap"));
		...
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains(
				"AssociationReference = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("ComplexMap = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("SimpleMap = 1"));
		assertTrue(ConceptReportHelper.getConceptReport(concept).contains("Simple = 1"));
