...
public class Handler007Test {
  ...
  @Test
	public void testHandlerNormalUse007() throws Exception {
	    ...
	    //TEST: the description with typeId=900000000000013009 and language refset member with 
	    //refSetId=900000000000509007 and acceptabilityId=900000000000548007 should return true - all others should return false.
	    for (Description description : sctConcept.getDescriptions()) {
	    	...
	    	for (LanguageRefSetMember lrm : lrms) {
	    		if (lrm.getRefSetId().equals("900000000000509007") && lrm.getAcceptabilityId().equals("900000000000548007")) {
	    			lrmsFound = true;
	    		}
	    	}
  ...
  public void testHandlerEdgeCases007() throws Exception {
	  ...
	  //TEST: returns null
	  assertEquals(handlerService.computePreferredName(new HashSet<Description>()), null);
