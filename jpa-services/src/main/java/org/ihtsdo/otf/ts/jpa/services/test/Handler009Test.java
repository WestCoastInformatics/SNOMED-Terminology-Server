...
public class Handler009Test {
  ...
  public void testHandlerNormalUse009() throws Exception {
     ...
     * getTerminologyId() on the concept TEST: the terminology id is a valid
     * UUID Clear the terminology id Call getTerminologyId() on the relationship
     * TEST: the terminology id is a valid UUID Reset the terminology id to the
     * original value
     */
     ...
     * id is a valid UUID Clear the terminology id Call getTerminologyId() on
     * the relationship TEST: the terminology id is a valid UUID Reset the
     * terminology id to the original value
     */
     ...
     * terminology id is a valid UUID Clear the terminology id Call
     * getTerminologyId() on the relationship TEST: the terminology id is a
     * valid UUID Reset the terminology id to the original value
     */
     ...
     * language refset member TEST: language refset member's terminology id is a
     * valid UUID
     */
     ...
     * member TEST: the association reference refset member's terminology id is
     * a valid UUID
     */
     ...
     * handlerService.getTerminologyId(sctArdrm); try { UUID.fromString(id); }
     ...
     * service. Call getTerminologyId() on the complex map refset member TEST:
     * the complex map refset member's terminology id is a valid UUID
     */
