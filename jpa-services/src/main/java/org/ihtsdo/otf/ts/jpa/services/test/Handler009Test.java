...
import org.ihtsdo.otf.ts.jpa.services.handlers.SnomedUuidHashIdentifierAssignmentHandler;
...
/**
 * Integration testing for {@link SnomedUuidHashIdentifierAssignmentHandler}.
 */
public class Handler009Test {
  ...
  public void setup() {    
    ...
    try {
		handlerService = new SnomedUuidHashIdentifierAssignmentHandler();
	} catch (Exception e) {
		e.printStackTrace();
	}
  }
  ...
  @Test
	public void testHandlerNormalUse009() throws Exception {
		Logger.getLogger(getClass()).info("TEST testHandlerNormalUse009");

		/*
		Retrieve concept 102276005 (SNOMEDCT) from the content service.
		Call getTerminologyId() on the concept
			TEST: the terminology id is a valid UUID
		Clear the terminology id 
	    Call getTerminologyId() on the relationship
	    	TEST: the terminology id is a valid UUID
	    Reset the terminology id to the original value
	    */
	    ...
	    try {
	    	...
	    	fail("Concept terminology id not in UUID format.");
	    }
	    ...
	    Call getTerminologyId() on the description	    
	        TEST: the description's terminology id is a valid UUID
	    Clear the terminology id 
	    Call getTerminologyId() on the relationship
	    	TEST: the terminology id is a valid UUID
	    Reset the terminology id to the original value
	    */
	    ...
	    Call getTerminologyId() on the relationship
	        TEST: the relationship's terminology id is a valid UUID
	    Clear the terminology id 
	    Call getTerminologyId() on the relationship
	    	TEST: the terminology id is a valid UUID
	    Reset the terminology id to the original value
	    */ 	
	    ...
	    Call getTerminologyId() on the language refset member	    
	    ...
	    Call getTerminologyId() on the attribute value refset member	    
	    ...
	    Call getTerminologyId() on the association reference refset member	    
	        TEST: the association reference refset member's terminology id is a valid UUID*/
	    ...
	    id = handlerService.getTerminologyId(sctArdrm);
	    try {
	    	UUID.fromString(id);
	    } catch (Exception e) {
	    	fail("Association reference description refset member terminology id not in UUID format.");
	    } 	  */
	    
	    /*
	    Retrieve a complex map refset member "abcac540-87be-5405-9048-f14333f3abc2" (SNOMEDCT) from the content service.
	    Call getTerminologyId() on the complex map refset member	    
	    ...
	    Call getTerminologyId() on the description type refset member	    
	    ...
	    Call getTerminologyId() on the module dependency refset member	    
	        TEST: the module dependency refset member's terminology id is a valid UUID*/
	    ...
	    Call getTerminologyId() on the refset descriptor refset member
	    
	        TEST: the refset descriptor refset member's terminology id is a valid UUID*/
	    ...
	    Call getTerminologyId() on the simple map refset member
	    ...
	    Call getTerminologyId() on the simple refset member
   ...
   */
  /**
   * Test handler degenerate use009.
   *
   * @throws Exception the exception
   */
  @Test
	public void testHandlerDegenerateUse009() throws Exception {
		...
		// TEST: exception
		try {
			handlerService.getTerminologyId((AttributeValueDescriptionRefSetMember) null);
   ...
   */
  @Test
  public void testHandlerEdgeCases009() throws Exception {
	  ...
	  handlerService.getTerminologyId(new AttributeValueDescriptionRefSetMemberJpa());
	  
	  handlerService.getTerminologyId(new AssociationReferenceConceptRefSetMemberJpa());
	  
	  handlerService.getTerminologyId(new AssociationReferenceDescriptionRefSetMemberJpa());
